...
function Header() {
  ...
  useEffect(() => {
    ...
    fetch('https://api.github.com/repos/wanfengwhiteboard/wanfengwhiteboard')
      .then((res) => res.json())
      .then((data) => {
      ...
      <div className="relative flex max-w-7xl items-center justify-between py-4 md:w-[65%]">
        <div className="mr-4 flex shrink-0 flex-row items-center" style={{ height: 45 }}>
          <div
            ...
            onClick={() => navigate('/')}
          >
            <img src={Logo} className="w-[35px]" alt="万峰白板" />
            <span className="ml-2 text-base font-bold">万峰白板</span>
          </div>
                ...
                onClick={() => {
                  switch (item.value) {
                    ...
                    case 'pricing':
                      ...
                      break;
                    case 'docs':
                      window.open('https://docs.wanfengwhiteboard.com', '_blank');
                      break;
                    case 'discord':
        ...
        <div className="flex items-center gap-2">
          <Button
            type="text"
            size="middle"
            onClick={() => window.open('https://github.com/wanfengwhiteboard/wanfengwhiteboard', '_blank')}
