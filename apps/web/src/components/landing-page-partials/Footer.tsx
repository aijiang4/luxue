...
const resources = [
  {
    title: 'docs',
    link: 'https://docs.wanfengwhiteboard.com',
  },
  {
    title: 'twitter',
    link: 'https://twitter.com/wanfengwhiteboard',
  },
  {
    title: 'github',
    link: 'https://github.com/wanfengwhiteboard',
  },
  {
    title: 'discord',
          ...
          >
            ...
            <div className="flex flex-col items-center justify-center gap-4 sm:flex-row">
              ...
              <Button
                size="large"
                onClick={() => {
                  window.open('https://github.com/wanfengwhiteboard/wanfengwhiteboard', '_blank');
                }}
          ...
          >
            ...
            <div className="grid grid-cols-1 gap-8 lg:grid-cols-[40%_1fr]">
              ...
              <div className="w-full">
                <Link to="/" className="mb-4 inline-block no-underline" aria-label="万峰白板">
                  <div className="flex items-center gap-2">
                    <img src={Logo} alt="" className="h-8 w-8" />
                    <span className="text-xl font-bold text-black">万峰白板</span>
                  </div>
                </Link>
                ...
                <div className="flex items-center justify-start gap-3">
                  ...
                  <div className="flex items-center gap-2">
                    <Link
                      to="https://twitter.com/wanfengwhiteboard"
                      target="_blank"
                    ...
                    <Link
                      to="https://github.com/wanfengwhiteboard"
                      target="_blank"
                      className="rounded-md px-2 py-1 text-gray-500 no-underline transition hover:text-gray-700"
                      aria-label="GitHub"
                    >
                    ...
                    <Link
                      to="mailto:support@wanfengwhiteboard.com"
                      target="_blank"
                      className="rounded-md px-2 py-1 text-gray-500 no-underline transition hover:text-gray-700"
                      aria-label="Discord"
                    >
                  ...
                  <div>
                    ...
                    <ul className="list-none text-sm">
                      <li key="privacy" className="mb-1">
                        <Link
                          to="https://docs.wanfengwhiteboard.com/about/privacy-policy"
                          target="_blank"
                          className="text-gray-500 no-underline transition duration-150 ease-in-out hover:text-gray-700"
                        >
                      ...
                      <li key="terms" className="mb-1">
                        <Link
                          to="https://docs.wanfengwhiteboard.com/about/terms-of-service"
                          target="_blank"
                          className="text-gray-500 no-underline transition duration-150 ease-in-out hover:text-gray-700"
                        >
                  ...
                  <div>
                    ...
                    <ul className="list-none text-sm">
                      <li key="community" className="mb-1">
                        <Link
                          to="https://docs.wanfengwhiteboard.com/community/contact-us"
                          target="_blank"
                          className="text-gray-500 no-underline transition duration-150 ease-in-out hover:text-gray-700"
                        >
